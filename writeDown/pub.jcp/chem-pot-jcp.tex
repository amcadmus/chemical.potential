...
\hline
\recheck{water} & -- & -22.1 $\pm$ 0.2  & -- & -23.5 \cite{florian} \\
...
\recheck{methanol in methanol/water mixture} & 0.01 & -19.0 $\pm$ 0.2 & -- & -- \\
\recheck{methane in methane/water mixture} & 0.006 & 9.3 $\pm$ 0.2  & -- & -- \\
urea in urea/water mixture & 0.02 & -56.1 $\pm$ 0.6 & -58.2 $\pm$ 0.5 & -57.8 $\pm$ 2.5 \cite{urea} \\
\recheck{ethane in ethane/water mixture} & 0.006 & 7.2 $\pm$ 0.2 & -- & -- \\ 
...
($-42$~kJ/mol, we picked a very small value because the TBA molecule is highly hydrophilic)
...
Electrostatic interactions beyond the cut-off radius were calculated using the reaction-field term \cite{rf} with a dielectric 
