...
\section{Extension of the chemical potential derivation to multi-component systems}
...
\end{align}
where, $N^\typea_1$ and $N^\typeb_1$ denote the number of type $\typea$ and
type $\typeb$ molecules in the atomistic region ($N^\typea_3$ and $N^\typeb_3$ in the CG region instead).  In the thermodynamic
limit, these numbers maximize the Helmholtz free energy.
...
identify $\omega_\ext^{\typea\typeb}$ with $\omega_\res^{\typea\typeb}$
