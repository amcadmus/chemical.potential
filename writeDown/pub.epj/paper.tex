...
%
\abstract{ In this paper, we discuss the necessary conditions for
  ...
  discussed and compared in parallel.  We further demonstrate the
  accuracy of AdResS in computing dynamical properties, which are not
  equilibrium ensemble averages, by the velocity auto-correlation of pure water
  and conformational relaxation of alanine dipeptide dissolved in water.
  Open questions are discussed in the end of the paper.
} %end of abstract
%
\maketitle
%
